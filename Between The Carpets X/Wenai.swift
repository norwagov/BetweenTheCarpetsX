...
class Wenai: SKScene, SKPhysicsContactDelegate {
    ...
    override func sceneDidLoad() {
        ...
        createAdn.createAdnotation(in: self, with: "Now: Pov Wenai!", who: .amogus, isRankedUp: false, P: P)
        DispatchQueue.main.asyncAfter(deadline: .now() + 4.0) {
            createAdn.createAdnotation(in: self, with: "Teraz będzie trudniej.", who: .baran, isRankedUp: false, P: self.P)
            DispatchQueue.main.asyncAfter(deadline: .now() + 4.0) {
                createAdn.createAdnotation(in: self, with: "Rozwal 17 Wenaiów!", who: .amogus, isRankedUp: false, P: self.P)
            }
        }
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        //print(self.P.position)
        
        if self.P.frags == 17 {
            DispatchQueue.main.asyncAfter(deadline: .now() + 10) {
                let scene = SKScene(fileNamed: "Lorek")
        ...
        INSTANCE.Position = self.P.position
